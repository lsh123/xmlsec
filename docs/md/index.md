...
The XML Security Library is a C library based on [LibXML2](http://xmlsoft.org/).
...
- [Canonical XML 1.1](http://www.w3.org/TR/xml-c14n11/) (part of [LibXML2](http://xmlsoft.org/))
...
- **April 22, 2026**
  ...
  - (xmlsec-windows) The XMLSec build configuration script on Windows was converted to PowerShell; the JScript version is
...
- **April 2, 2026**
  ...
  - (xmlsec-nss) Added support for EdDSA (Ed25519) signature algorithms; ECDH and XDH (X25519) key agreement algorithms;
    ConcatKDF and HKDF key derivation algorithms; ChaCha20-Poly1305 encryption algorithm; and Camellia block cipher and key wrap algorithms.
...
- **July 19, 2024**
  ...
  - (xmlsec-core) Fixed deprecated functions in LibXML2 2.13.1, including disabling HTTP support
