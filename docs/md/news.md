...
- TODO  
  The [XML Security Library 1.3.11](download.html) release includes the following changes:
  - TODO

- April 2, 2026  
  The [XML Security Library 1.3.10](download.html) release includes the following changes:
...
- November 10, 2025  
  The [XML Security Library 1.3.9](download.html) release includes the following changes:
...
- October 15, 2025  
  The [XML Security Library 1.3.8](download.html) release includes the following changes:
...
- June 16, 2025  
  The legacy [XML Security Library 1.2.42](download.html) release includes the following changes:
...
- February 11, 2025  
  The [XML Security Library 1.3.7](download.html) release includes the following changes:
...
- October 22, 2024  
  The [XML Security Library 1.3.6](download.html) release includes the following changes:
...
- July 19, 2024  
  The [XML Security Library 1.3.5 and legacy 1.2.41](download.html) releases include the following changes:
...
- April 9, 2024  
  The [XML Security Library 1.3.4](download.html) release includes the following changes:
...
- January 4, 2024  
  The [XML Security Library 1.3.3](download.html) release includes the following changes:
  - (xmlsec-core) Disabled KeyValue and DEREncodedKeyValue XML nodes by default. Use the '--enabled-key-data' option
    ...
    (also see [question 3.5 in the FAQ](faq.html#section_3_5)).
...
- October 31, 2023  
  The [XML Security Library 1.3.2](download.html) release includes the following changes:
...
- June 6, 2023  
  The [XML Security Library 1.3.1](download.html) release includes the following changes:
...
- April 12, 2023  
  The [XML Security Library 1.3.0](download.html) release includes the following changes:
  ...
  [XMLDsig](xmldsig.html) and [XMLEnc](xmlenc.html) interoperability reports.

- November 30, 2022  
  The [XML Security Library 1.2.37](download.html) release includes the following changes:
...
- October 31, 2022  
  The [XML Security Library 1.2.36](download.html) release includes the following changes:
  - Retired the XMLSec mailing list "xmlsec@aleksey.com" and the XMLSec Online Signature Verifier.
  - Several other small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- October 25, 2022  
  The [XML Security Library 1.2.35](download.html) release includes the following changes:
...
- May 3, 2022  
  The [XML Security Library 1.2.34](download.html) release includes the following changes:
  - Support for OpenSSL compiled with OPENSSL_NO_ERR.
  - Full support for LibreSSL 3.5.0 and above (@vishwin).
  - Several other small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- October 25, 2021  
  The [XML Security Library 1.2.33](download.html) release includes the following changes:
...
- April 21, 2021  
  The [XML Security Library 1.2.32](download.html) release includes the following changes:
  - Several small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- October 29, 2020  
  The [XML Security Library 1.2.31](download.html) release includes the following changes:
  - Added configure option to ensure memset() securely erases memory (gcc).
  - Several other small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- April 21, 2020  
  The [XML Security Library 1.2.30](download.html) release includes the following changes:
  - Enabled XML_PARSE_HUGE for all xml parsers.
  - Added s390x support for travis (nayana-ibm).
  - Several other small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- October 15, 2019  
  The [XML Security Library 1.2.29](download.html) release includes the following changes:
  - Various build and tests fixes and improvements.
  - Move remaining private header files away from xmlsec/include/ folder.
  - Several other small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- April 16, 2019  
  The [XML Security Library 1.2.28](download.html) release includes the following changes:
...
- October 23, 2018  
  The [XML Security Library 1.2.27](download.html) release includes the following changes:
...
- June 5, 2018  
  The [XML Security Library 1.2.26](download.html) release includes the following changes:
...
- September 12, 2017  
  The [XML Security Library 1.2.25](download.html) release includes the following changes:
...
- April 20, 2017  
  The [XML Security Library 1.2.24](download.html) release includes the following changes:
...
- October 16, 2016  
  The [XML Security Library 1.2.23](download.html) release includes the following changes:
  - Full support for OpenSSL 1.1.0.
  - Several other small fixes ([more details](https://github.com/lsh123/xmlsec/commits/master)).

- April 20, 2016  
  The [XML Security Library 1.2.22](download.html) release includes the following changes:
  - Restored SOAP parser to support backward compatibility for Lasso project.

- April 12, 2016  
  The [XML Security Library 1.2.21](download.html) release includes the following changes:
...
- May 27, 2014  
  The [XML Security Library 1.2.20](download.html) release fixes a number of miscellaneous bugs and
  updates expired or soon-to-be-expired certificates in the test suite.

- March 24, 2013  
  The [XML Security Library 1.2.19](download.html) release adds support for DSA-SHA256, ECDSA-SHA1,
  ECDSA-SHA224, ECDSA-SHA256, ECDSA-SHA384, ECDSA-SHA512 and fixes a number of miscellaneous bugs.

- May 11, 2011  
  The [XML Security Library 1.2.18](download.html) release fixes
  a serious crasher. All users are advised to upgrade as soon as possible.

- March 31, 2011  
  Changes in [XML Security Library 1.2.17](download.html) release:
...
- May 26, 2010  
  Changes in [XML Security Library 1.2.16](download.html) release:
...
- April 29, 2010  
  Changes in [XML Security Library 1.2.15](download.html) release:
...
- December 5, 2009  
  Changes in [XML Security Library 1.2.14](download.html) release:
...
- September 12, 2009  
  Changes in [XML Security Library 1.2.13](download.html) release:
...
- July 14, 2009  
  The new [XML Security Library 1.2.12](download.html) release
...
- November 6, 2007  
  The new [XML Security Library 1.2.11](download.html) release
...
- June 12, 2006  
  The new [XML Security Library 1.2.10](download.html) release
  includes the following changes:
...
- November 11, 2003  
  The new [XML Security Library 1.2.2](download.html)
...
- October 14, 2003  
  The new [XML Security Library 1.2.1](download.html)
...
- September 30, 2003  
  The major change in the new [XML Security Library 1.2.0](download.html)
...
- September 17, 2003  
  The new [XML Security Library 1.1.2](download.html) release
...
- August 21, 2003  
  The new [XML Security Library 1.1.1](download.html) release
...
- August 5, 2003  
  ...
  [XML Security Library 1.1.0](download.html)
...
- July 15, 2003  
  ...
  a new [XML Security Library 1.0.4](download.html)
...
- April 28, 2003  
  The [XML Security Library 1.0.1](download.html)
...
- April 17, 2003  
  The [XML Security Library 1.0.0](download.html)
...
- April 10, 2003  
  The final release candidate [XML Security Library 1.0.0rc1](download.html) is available for download. This release includes
  minor API polishing,
  complete [API Reference Manual](api/xmlsec-ref.html),
  new chapters in the [tutorial](tutorial/index.html) and
  several new [examples](examples/index.html).
...
- April 8, 2003  
  The new [XML Security Library 0.0.15](download.html)
...
- March 26, 2003  
  [XML Security Library 0.1.1](download.html)
  ...
  for XML transforms, [new documentation](api/index.html),
  updated [examples](examples/index.html)
...
- March 5, 2003  
  ...
  (please use the [stable 0.0.X](download.html) releases
...
- February 21, 2003  
  [XML Security Library 0.0.13](download.html) release
...
- January 26, 2003  
  ...
  algorithms are the reason for the new [XML Security Library 0.0.12](download.html) release.
  Also there are few other minor features and bug fixes (see Changelog in the
  distribution for more details).

- December 3, 2002  
  New [XML Security Library 0.0.11](download.html) release
...
- October 20, 2002  
  ...
  [XML Security Library 0.0.10](download.html) release:
...
- August 26, 2002  
  ...
  and I am doing a new [0.0.9 release](download.html)
...
- August 23, 2002  
  [XML Security Library 0.0.8](download.html) is released:
  ...
  - [Man page](xmlsec-man.html) for xmlsec utility is written.
  - Automatically generated [API Reference](documentation.html) Manual (more than 370 symbols) is created.
  - Minor Win32 bug fixes from Igor.
  - Debian port from John Belmonte.

- July 11, 2002  
  XML Security Library [documentation](documentation.html) created.

- July 10, 2002  
  A new [XML Security Library 0.0.7](download.html) release
  includes all small bug fixes for last month and a new LibXML2 library
  with improved canonicalization.

- May 28, 2002  
  New LibXML 2.4.22 is [released](http://xmlsoft.org/news.html)
  and new [XML Security Library 0.0.6](download.html) is released:
...
- April 28, 2002  
  [XMLSec 0.0.5](download.html) released:
...
- April 19, 2002  
  Minor release [XMLSec 0.0.4](download.html) with main
...
- April 16, 2002  
  A lot of changes and time for new release [XMLSec 0.0.3](download.html):
  - The first release that includes [XML Encryption support](xmlenc.html)!
    The bad news is that most of new features require [OpenSSL 0.9.7](download.html) which is
...
- April 6, 2002  
  The [RPM packages](download.html) are now available.

- April 5, 2002  
  Test suite updates and new minor release [XML Security Library 0.0.2a](download.html).  
...
- March 31, 2002  
  Some major changes and a time for new release: [XML Security Library 0.0.2](download.html). Now XML Security Library supports **all** MUST/SHOULD/MAY
  [features](xmldsig.html) from XMLDSig standard!
...
- March 18, 2002
  - Fixed wrong way shift of the DSA digest result bug found by Philipp Gühring. This bug is critical and I have to do a [new build](download.html).
  - Added "--with-pedantic" configuration option and fixed all but "unused variable" warnings (bug reported by Daniel Veillard).

- March 17, 2002  
  The [XML Security Library 0.0.1](download.html) is released
