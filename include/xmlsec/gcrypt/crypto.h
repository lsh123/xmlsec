...
/** @brief Deprecated: use xmlSecGCryptKeyDataEcGetKlass. Retained for source compatibility with the misspelled name released in 1.3.0. */
 ...
 * @details The RSA OAEP-Enc11 key transport transform klass (XMLEnc 1.1).
 */
