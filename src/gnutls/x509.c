...
xmlSecGnuTLSKeyDataX509AdoptCert(xmlSecKeyDataPtr data, gnutls_x509_crt_t cert) {
    ...
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecPtrListAdd");
        return(-1);
    }
...
xmlSecGnuTLSKeyDataX509Duplicate(xmlSecKeyDataPtr dst, xmlSecKeyDataPtr src) {
    ...
    if(ctxSrc->keyCert != NULL) {
        ...
        if(ctxDst->keyCert == NULL) {
            xmlSecInternalError(xmlSecKeyDataGetName(src), "xmlSecGnuTLSX509CertDup");
            return(-1);
        }
    }
...
xmlSecGnuTLSKeyDataX509XmlRead(xmlSecKeyDataId id, xmlSecKeyPtr key,
    ...
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataKlassGetName(id), "xmlSecGnuTLSX509DataNodeRead");
        return(-1);
    }
    ...
    if((keyInfoCtx->flags & XMLSEC_KEYINFO_FLAGS_X509DATA_DONT_VERIFY_CERTS) == 0) {
        ...
        if(ret < 0) {
            xmlSecInternalError(xmlSecKeyDataKlassGetName(id), "xmlSecGnuTLSKeyDataX509VerifyAndExtractKey");
            return(-1);
        }
    }
    return(0);
...
xmlSecGnuTLSX509CertificateNodeRead(xmlSecKeyDataPtr data, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
    ...
    if(cert == NULL) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecGnuTLSX509CertBase64DerRead");
        xmlFree(content);
        return(-1);
    }
    ...
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecGnuTLSKeyDataX509AdoptCert");
...
xmlSecGnuTLSX509SubjectNameNodeRead(xmlSecKeyDataPtr data, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
    ...
    if(cert2 == NULL) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecGnuTLSX509CertDup");
...
xmlSecGnuTLSX509IssuerSerialNodeWrite(gnutls_x509_crt_t cert, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx ATTRIBUTE_UNUSED) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecGnuTLSX509CertGetIssuerSerial");
        return(-1);
    }
...
xmlSecGnuTLSX509SKINodeWrite(gnutls_x509_crt_t cert, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx ATTRIBUTE_UNUSED) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecGnuTLSX509CertGetSKI");
        return(-1);
    }
...
xmlSecGnuTLSX509CRLNodeRead(xmlSecKeyDataPtr data, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
    ...
    if(crl == NULL) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecGnuTLSX509CrlBase64DerRead");
        xmlFree(content);
        return(-1);
    }
    ...
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecGnuTLSKeyDataX509AdoptCrl");
...
xmlSecGnuTLSKeyDataX509VerifyAndExtractKey(xmlSecKeyDataPtr data, xmlSecKeyPtr key,
    ...
    if((ctx->keyCert == NULL) && (xmlSecPtrListGetSize(&(ctx->certsList)) > 0) && (xmlSecKeyGetValue(key) == NULL)) {
        ...
        if(cert != NULL) {
            ...
            if(keyValue == NULL) {
                xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecGnuTLSX509CertGetKey");
                return(-1);
            }
    ...
    case GNUTLS_PK_RSA:
        {
            ...
            if(ret < 0) {
                xmlSecInternalError(NULL, "xmlSecGnuTLSKeyDataRsaAdoptPublicKey");
                gnutls_free(m.data);
                gnutls_free(e.data);
                return(NULL);
            }
    ...
    case GNUTLS_PK_DSA:
        {
            ...
            if(ret < 0) {
                xmlSecInternalError(NULL, "xmlSecGnuTLSKeyDataDsaAdoptPublicKey");
                gnutls_free(p.data);
                gnutls_free(q.data);
                gnutls_free(g.data);
                gnutls_free(y.data);
...
xmlSecGnuTLSKeyDataRawX509CertBinRead(xmlSecKeyDataId id, xmlSecKeyPtr key,
    ...
    if(cert == NULL) {
        xmlSecInternalError(NULL, "xmlSecGnuTLSX509CertRead");
        return(-1);
    }
    ...
    ret = xmlSecGnuTLSKeyDataX509AdoptCert(data, cert);
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataKlassGetName(id), "xmlSecGnuTLSKeyDataX509AdoptCert");
        gnutls_x509_crt_deinit(cert);
        return(-1);
    }
