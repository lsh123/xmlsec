...
xmlSecCryptoGetFunctions_mscrypto(void) {
    ...
    gXmlSecMSCryptoFunctions->cryptoAppKeysMngrCrlLoadAndVerify = xmlSecMSCryptoAppKeysMngrCrlLoadAndVerify;
    ...
    gXmlSecMSCryptoFunctions->cryptoAppDefaultPwdCallback       = xmlSecMSCryptoAppGetDefaultPwdCallback;
