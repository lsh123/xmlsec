...
xmlSecNssKeyDataX509Duplicate(xmlSecKeyDataPtr dst, xmlSecKeyDataPtr src) {
    ...
    for(pos = 0; pos < size; ++pos) {
        ...
        if(ret < 0) {
            xmlSecInternalError(xmlSecKeyDataGetName(dst), "xmlSecNssKeyDataX509AdoptCert");
    ...
    for(pos = 0; pos < size; ++pos) {
        ...
        if(ret < 0) {
            xmlSecInternalError(xmlSecKeyDataGetName(dst), "xmlSecNssKeyDataX509AdoptCrl");
    ...
    if(certSrc != NULL) {
        ...
        if(ret < 0) {
            xmlSecInternalError(xmlSecKeyDataGetName(dst), "xmlSecNssKeyDataX509AdoptKeyCert");
            CERT_DestroyCertificate(certDst);
            return(-1);
        }
    }
...
xmlSecNssKeyDataX509XmlRead(xmlSecKeyDataId id, xmlSecKeyPtr key,
    ...
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataKlassGetName(id), "xmlSecNssX509DataNodeRead");
        return(-1);
    }
    ...
    if((keyInfoCtx->flags & XMLSEC_KEYINFO_FLAGS_X509DATA_DONT_VERIFY_CERTS) == 0) {
        ...
        if(ret < 0) {
            xmlSecInternalError(xmlSecKeyDataKlassGetName(id), "xmlSecNssKeyDataX509VerifyAndExtractKey");
            return(-1);
        }
    }
    return(0);
...
xmlSecNssX509CertificateNodeRead(xmlSecKeyDataPtr data, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
    ...
    if(cert == NULL) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecNssX509CertBase64DerRead");
        xmlFree(content);
        return(-1);
    }
    ...
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecNssKeyDataX509AdoptCert");
...
xmlSecNssX509CertificateNodeWrite(CERTCertificate* cert, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssX509CertBase64DerWrite");
        return(-1);
    }
...
xmlSecNssX509SubjectNameNodeWrite(CERTCertificate* cert, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx ATTRIBUTE_UNUSED) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssX509NameWrite(&(cert->subject))");
        return(-1);
    }
...
xmlSecNssX509IssuerSerialNodeWrite(CERTCertificate* cert, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx ATTRIBUTE_UNUSED) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssX509NameWrite(&(cert->issuer))");
        return(-1);
    }
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssASN1IntegerWrite(&(cert->serialNumber))");
        return(-1);
    }
...
xmlSecNssX509SKINodeWrite(CERTCertificate* cert, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx ATTRIBUTE_UNUSED) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssX509SKIWrite");
        return(-1);
    }
...
xmlSecNssX509CRLNodeRead(xmlSecKeyDataPtr data, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
   ...
   if((content == NULL) || (xmlSecIsEmptyString(content) == 1)) {
    ...
    if(crl == NULL) {
        xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecNssX509CrlBase64DerRead");
        xmlFree(content);
        return(-1);
    }
...
xmlSecNssX509CRLNodeWrite(CERTSignedCrl* crl, xmlNodePtr node, xmlSecKeyInfoCtxPtr keyInfoCtx) {
    ...
    if(buf == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssX509CrlBase64DerWrite");
        return(-1);
    }
...
xmlSecNssKeyDataX509VerifyAndExtractKey(xmlSecKeyDataPtr data, xmlSecKeyPtr key,
    ...
    if((ctx->keyCert == NULL) && (ctx->certsList != NULL) && (xmlSecKeyGetValue(key) == NULL)) {
        ...
        if(cert != NULL) {
            ...
            if(keyValue == NULL) {
                xmlSecInternalError(xmlSecKeyDataGetName(data), "xmlSecNssX509CertGetKey");
                return(-1);
            }
...
xmlSecNssKeyDataRawX509CertBinRead(xmlSecKeyDataId id, xmlSecKeyPtr key,
    ...
    if(cert == NULL) {
        xmlSecInternalError(NULL, "xmlSecNssX509CertDerRead");
        return(-1);
    }
    ...
    ret = xmlSecNssKeyDataX509AdoptCert(data, cert);
    if(ret < 0) {
        xmlSecInternalError(xmlSecKeyDataKlassGetName(id), "xmlSecNssKeyDataX509AdoptCert");
        CERT_DestroyCertificate(cert);
        return(-1);
    }
