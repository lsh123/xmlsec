...
xmlSecTmplSignatureCreateNsPref(xmlDocPtr doc, xmlSecTransformId c14nMethodId,
    ...
    if(signedInfoNode == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeSignedInfo)");
        xmlFreeNode(signNode);
        return(NULL);
    }
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeSignatureValue)");
        xmlFreeNode(signNode);
        return(NULL);
    }
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeCanonicalizationMethod)");
        xmlFreeNode(signNode);
        return(NULL);
    }
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeSignatureMethod)");
        xmlFreeNode(signNode);
        return(NULL);
    }
...
xmlSecTmplSignatureEnsureKeyInfo(xmlNodePtr signNode, const xmlChar *id) {
    ...
    if(res == NULL) {
        ...
        if(res == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddNextSibling(xmlSecNodeKeyInfo)");
            return(NULL);
        }
    }
    if(id != NULL) {
...
xmlSecTmplAddReference(xmlNodePtr parentNode, xmlSecTransformId digestMethodId,
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeReference)");
        return(NULL);
    }
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeDigestMethod)");
        xmlUnlinkNode(res);
        xmlFreeNode(res);
        return(NULL);
    }
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeDigestValue)");
        xmlUnlinkNode(res);
        xmlFreeNode(res);
        return(NULL);
    }
...
xmlSecTmplSignatureAddObject(xmlNodePtr signNode, const xmlChar *id,
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeObject)");
        return(NULL);
    }
    if(id != NULL) {
        xmlSetProp(res, xmlSecAttrId, id);
...
xmlSecTmplReferenceAddTransform(xmlNodePtr referenceNode, xmlSecTransformId transformId) {
    ...
    if(transformsNode == NULL) {
        ...
        if(transformsNode == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild or xmlSecAddPrevSibling(xmlSecNodeTransforms)");
            return(NULL);
        }
    }
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeTransform)");
        return(NULL);
    }
...
xmlSecTmplObjectAddSignProperties(xmlNodePtr objectNode, const xmlChar *id, const xmlChar *target) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeSignatureProperties)");
        return(NULL);
    }
    if(id != NULL) {
        xmlSetProp(res, xmlSecAttrId, id);
...
xmlSecTmplObjectAddManifest(xmlNodePtr objectNode,  const xmlChar *id) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeManifest)");
        return(NULL);
    }
    if(id != NULL) {
        xmlSetProp(res, xmlSecAttrId, id);
...
xmlSecTmplPrepareEncData(xmlNodePtr parentNode, xmlSecTransformId encMethodId) {
    ...
    if(encMethodId != NULL) {
        ...
        if(cur == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeEncryptionMethod)");
            return(-1);
        }
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeCipherData)");
        return(-1);
    }
...
xmlSecTmplEncDataEnsureKeyInfo(xmlNodePtr encNode, const xmlChar* id) {
    ...
    if(res == NULL) {
        ...
        if(res == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddPrevSibling(xmlSecNodeKeyInfo)");
            return(NULL);
        }
    }
    if(id != NULL) {
...
xmlSecTmplEncDataEnsureEncProperties(xmlNodePtr encNode, const xmlChar *id) {
    ...
    if(res == NULL) {
        ...
        if(res == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeEncryptionProperties)");
            return(NULL);
        }
    }
...
xmlSecTmplEncDataAddEncProperty(xmlNodePtr encNode, const xmlChar *id, const xmlChar *target) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeEncryptionProperty)");
        return(NULL);
    }
    if(id != NULL) {
        xmlSetProp(res, xmlSecAttrId, id);
...
xmlSecTmplEncDataEnsureCipherValue(xmlNodePtr encNode) {
    ...
    if(res == NULL) {
        ...
        if(res == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeCipherValue)");
            return(NULL);
        }
    }
...
xmlSecTmplEncDataEnsureCipherReference(xmlNodePtr encNode, const xmlChar *uri) {
    ...
    if(res == NULL) {
        ...
        if(res == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeCipherReference)");
            return(NULL);
        }
    }
...
xmlSecTmplCipherReferenceAddTransform(xmlNodePtr cipherReferenceNode,
    ...
    if(transformsNode == NULL) {
        ...
        if(transformsNode == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeTransforms)");
            return(NULL);
        }
    }
...
xmlSecTmplReferenceListAddDataReference(xmlNodePtr encNode, const xmlChar *uri) {
    ...
    if(refListNode == NULL) {
        ...
        if(refListNode == NULL) {
            xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeReferenceList)");
            return(NULL);
        }
    }
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeDataReference)");
        return(NULL);
    }
...
xmlSecTmplReferenceListAddKeyReference(xmlNodePtr encNode, const xmlChar *uri) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeKeyReference)");
        return(NULL);
    }
...
xmlSecTmplKeyInfoAddKeyName(xmlNodePtr keyInfoNode, const xmlChar* name) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeKeyName)");
        return(NULL);
    }
    if(name != NULL) {
...
xmlSecTmplKeyInfoAddKeyValue(xmlNodePtr keyInfoNode) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeKeyValue)");
        return(NULL);
    }
...
xmlSecTmplKeyInfoAddX509Data(xmlNodePtr keyInfoNode) {
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509Data)");
        return(NULL);
    }
...
xmlSecTmplKeyInfoAddRetrievalMethod(xmlNodePtr keyInfoNode, const xmlChar *uri,
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeRetrievalMethod)");
        return(NULL);
    }
...
xmlSecTmplKeyInfoAddEncryptedKey(xmlNodePtr keyInfoNode, xmlSecTransformId encMethodId,
    ...
    if(encKeyNode == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeEncryptedKey)");
        return(NULL);
    }
...
xmlSecTmplX509DataAddIssuerSerial(xmlNodePtr x509DataNode) {
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509IssuerSerial)");
        return(NULL);
    }
...
xmlSecTmplX509IssuerSerialAddIssuerName(xmlNodePtr x509IssuerSerialNode, const xmlChar* issuerName) {
  ...
  if(xmlSecFindChild(x509IssuerSerialNode, xmlSecNodeX509IssuerName,
    ...
    if(res == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509IssuerName)");
        return(NULL);
    }
...
xmlSecTmplX509IssuerSerialAddSerialNumber(xmlNodePtr x509IssuerSerialNode, const xmlChar* serial) {
        ...
        if(res == NULL) {
                xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509SerialNumber)");
                return(NULL);
        }
...
xmlSecTmplX509DataAddSubjectName(xmlNodePtr x509DataNode) {
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509SubjectName)");
        return(NULL);
    }
...
xmlSecTmplX509DataAddSKI(xmlNodePtr x509DataNode) {
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509SKI)");
        return(NULL);
    }
...
xmlSecTmplX509DataAddCertificate(xmlNodePtr x509DataNode) {
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509Certificate)");
        return(NULL);
    }
...
xmlSecTmplX509DataAddCRL(xmlNodePtr x509DataNode) {
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeX509CRL)");
        return(NULL);
    }
...
xmlSecTmplTransformAddHmacOutputLength(xmlNodePtr transformNode, xmlSecSize bitsLen) {
    ...
    if(cur == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeHMACOutputLength)");
        return(-1);
    }
...
xmlSecTmplTransformAddRsaOaepParam(xmlNodePtr transformNode,
    ...
    if(oaepParamNode == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeRsaOAEPparams)");
        return(-1);
    }

    base64 = xmlSecBase64Encode(buf, size, 0);
    if(base64 == NULL) {
        xmlSecInternalError2(NULL, "xmlSecBase64Encode", "size=%d", size);
        return(-1);
    }
...
xmlSecTmplTransformAddC14NInclNamespaces(xmlNodePtr transformNode,
    ...
    if(cur == NULL) {
        xmlSecInternalError(xmlSecNodeGetName(transformNode),
                            "xmlSecAddChild(xmlSecNodeInclusiveNamespaces)");
        return(-1);
    }
...
xmlSecTmplTransformAddXPath(xmlNodePtr transformNode, const xmlChar *expression,
    ...
    if(xpathNode == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeXPath)");
        return(-1);
    }
...
xmlSecTmplTransformAddXPointer(xmlNodePtr transformNode, const xmlChar *expression,
    ...
    if(xpointerNode == NULL) {
        xmlSecInternalError(NULL, "xmlSecAddChild(xmlSecNodeXPointer)");
        return(-1);
    }
