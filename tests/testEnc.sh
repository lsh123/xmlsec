...
execEncTest() {    
    ...
    $binfolder/xmlsec decrypt $2 $file.xml > $tmpfile 2>> $logfile
    if [ $? = 0 ]; then
	...
	$binfolder/xmlsec encrypt $3 $file.tmpl > $tmpfile 2>> $logfile
	printRes
	
	if [ -n "$4" ] ; then 
	    printf "    Decrypt new document                                 "
	    echo "$binfolder/xmlsec decrypt $4 $tmpfile" >>  $logfile 
	    $binfolder/xmlsec decrypt $4 $tmpfile > $tmpfile.2 2>> $logfile
	    if [ $? = 0 ]; then
...
execEncTest "aleksey-xmlenc-01/enc-des3cbc-aes192-keyname" \
    ...
    "--keys keys.xml --binary aleksey-xmlenc-01/enc-des3cbc-aes192-keyname.data" \
    "--keys keys.xml"
...
execEncTest "merlin-xmlenc-five/encrypt-content-tripledes-cbc" \
    "--keys merlin-xmlenc-five/keys.xml" \
    "--keys merlin-xmlenc-five/keys.xml --xml merlin-xmlenc-five/encrypt-content-tripledes-cbc.data --node-id Payment" \
    "--keys merlin-xmlenc-five/keys.xml"
execEncTest "merlin-xmlenc-five/encrypt-content-aes256-cbc-prop" \
    "--keys merlin-xmlenc-five/keys.xml" \
    "--keys merlin-xmlenc-five/keys.xml --xml merlin-xmlenc-five/encrypt-content-aes256-cbc-prop.data --node-id Payment" \
    "--keys merlin-xmlenc-five/keys.xml"
...
execEncTest "merlin-xmlenc-five/encrypt-element-aes128-cbc-rsa-1_5" \
    ...
    "--keys merlin-xmlenc-five/keys.xml --privkey merlin-xmlenc-five/rsapriv.pem --xml merlin-xmlenc-five/encrypt-element-aes128-cbc-rsa-1_5.data --node-id Purchase"  \
    "--privkey merlin-xmlenc-five/rsapriv.pem"
execEncTest "merlin-xmlenc-five/encrypt-data-tripledes-cbc-rsa-oaep-mgf1p" \
    "--privkey merlin-xmlenc-five/rsapriv.pem" \
    "--keys merlin-xmlenc-five/keys.xml --privkey merlin-xmlenc-five/rsapriv.pem --binary merlin-xmlenc-five/encrypt-data-tripledes-cbc-rsa-oaep-mgf1p.data"  \
    "--privkey merlin-xmlenc-five/rsapriv.pem"


#merlin-xmlenc-five/decryption-transform-except.xml
#merlin-xmlenc-five/decryption-transform.xml
#merlin-xmlenc-five/encrypt-content-aes128-cbc-kw-aes192.xml
#merlin-xmlenc-five/encrypt-content-aes192-cbc-dh-sha512.xml
#merlin-xmlenc-five/encrypt-data-aes192-cbc-kw-aes256.xml
#merlin-xmlenc-five/encrypt-data-aes256-cbc-kw-tripledes.xml
...
#merlin-xmlenc-five/encrypt-element-tripledes-cbc-kw-aes128.xml
...
#merlin-xmlenc-five/encsig-ripemd160-hmac-ripemd160-kw-tripledes.xml
...
execEncTest "01-phaos-xmlenc-3/enc-element-3des-kt-rsa1_5" \
    ...
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-element-3des-kt-rsa1_5.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-element-3des-kt-rsa_oaep_sha1" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-element-3des-kt-rsa_oaep_sha1.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-content-aes256-kt-rsa1_5" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-content-aes256-kt-rsa1_5.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-element-aes128-kt-rsa1_5" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-element-aes128-kt-rsa1_5.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-element-aes128-kt-rsa_oaep_sha1" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-element-aes128-kt-rsa_oaep_sha1.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-element-aes192-kt-rsa_oaep_sha1" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-element-aes192-kt-rsa_oaep_sha1.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-text-aes192-kt-rsa1_5" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-text-aes192-kt-rsa1_5.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

execEncTest "01-phaos-xmlenc-3/enc-text-aes256-kt-rsa_oaep_sha1" \
    "--keys 01-phaos-xmlenc-3/keys.xml" \
    "--keys 01-phaos-xmlenc-3/keys.xml --xml 01-phaos-xmlenc-3/enc-text-aes256-kt-rsa_oaep_sha1.data --node-name http://example.org/paymentv2:CreditCard"  \
    "--keys 01-phaos-xmlenc-3/keys.xml"

#01-phaos-xmlenc-3/bad-alg-enc-element-aes128-kw-3des.xml
#01-phaos-xmlenc-3/enc-content-3des-kw-aes192.xml
#01-phaos-xmlenc-3/enc-content-aes128-kw-3des.xml
#01-phaos-xmlenc-3/enc-content-aes192-kw-aes256.xml
...
#01-phaos-xmlenc-3/enc-element-aes128-kw-aes256.xml
#01-phaos-xmlenc-3/enc-element-aes192-ka-dh.xml
#01-phaos-xmlenc-3/enc-element-aes192-kw-aes192.xml
#01-phaos-xmlenc-3/enc-element-aes256-ka-dh.xml
#01-phaos-xmlenc-3/enc-element-aes256-kw-aes256.xml
#01-phaos-xmlenc-3/enc-text-3des-kw-aes256.xml
#01-phaos-xmlenc-3/enc-text-aes128-kw-aes192.xml
