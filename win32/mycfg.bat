...
REM I am lazy to type all this  again and again
...
SET XMLSEC_OPTIONS=debug=yes with-dl=yes iconv=no cruntime=/MD xslt=yes crypto=%XMLSEC_CRYPTO% unicode=yes
