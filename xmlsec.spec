...
mkdir -p $RPM_BUILD_ROOT/usr/include/xmlsec-$(XMLSEC_RELEASE)
mkdir -p $RPM_BUILD_ROOT/usr/lib/xmlsec-$(XMLSEC_RELEASE)
...
%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-*.so.*
%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec.so
%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-openssl-*.so.*
%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-openssl.so
%{prefix}/bin/xmlsec
...
%{prefix}/include/xmlsec-$(XMLSEC_RELEASE)/xmlsec/*.h
%{prefix}/include/xmlsec-$(XMLSEC_RELEASE)/xmlsec/openssl/*.h
%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec.*a
%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-openssl.*a
%{prefix}/lib/pkgconfig/xmlsec.pc

#%files nss
#%defattr(-, root, root)  

#%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-nss-*.so.*
#%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-nss.so

#%files nss-devel
#%defattr(-, root, root)  

#%{prefix}/include/xmlsec-$(XMLSEC_RELEASE)/xmlsec/nss/*.h
#%{prefix}/lib/xmlsec-$(XMLSEC_RELEASE)/libxmlsec-nss.*a
